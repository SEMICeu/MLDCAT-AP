...
This document describes the (major) changes to [the current version 3.0.0](https://semiceu.github.io/MLDCAT-AP/releases/3.0.0/) of the MLDCAT-AP for which a new version is being proposed ([version 3.1.0](https://semiceu.github.io/MLDCAT-AP/releases/3.1.0/)).
...
## Detailed changes from v3.0.0 to v3.1.0
| Nr | MLDCAT-AP v3.0.0 | MLDCAT-AP v3.1.0 | Rationale | GitHub / Change |
| --- | --- | --- | --- | --- |
| R | - | foaf:Agent / prov:actedOnBehalfOf | for authorised representatives or agent | - |
| R | - | dcat:Dataset / prov:wasGeneratedBy | to reference an activity from which the dataset was generated by | - |
| R | - | dcat:Distribution / dct:conformsTo | to indicate a file providing the structure of the Distributio | - |
| C | - | prov:Acticity | as addition of the prov relations | - |
| C | - | dct:Standard | as addition of dct relations | - |
| R | it6:MachineLearningModel / it6:runnedOn | it6:MachineLearningModel / it6:ranOn | Using English language | - |
| P | it6:MachineLearningModel / it6:version | it6:MachineLearningModel / dcat:version | Reusing DCAT relation | - |
| P | it6:Benchmark / dct:title | it6:Benchmark / dct:title | extend cardinality to allow multiple title | - |
| R | dcat:Dataset / dct:language |  dcat:Dataset / dct:language | extend cardinality to be compatible with DCAT-AP | - |

In addition, there were improvements in the definitions and typos along the specification.
